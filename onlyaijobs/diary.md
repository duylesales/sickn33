...
- **18:35**: Làm bộ tài liệu marketing cho **OnlyAIJobs** — thư mục `onlyaijobs/` trước đó chỉ có 3 báo cáo audit, không có tài liệu thương hiệu hay kế hoạch nào. Trước khi viết, đã **quét trực tiếp https://onlyaijobs.eu** để lấy dữ liệu thật.
  - **Phát hiện lớn nhất khi quét — WAF đang đảo ngược hoàn toàn**: sau 39 ngày kể từ audit đầu tiên, BunkerWeb vẫn chặn `/`, `/robots.txt`, `/sitemap.xml` (302 → `/challenge`) với curl trần, UA Chrome **và UA Googlebot**. Nhưng **GPTBot/1.0 và ClaudeBot/1.0 nhận HTTP 200 với toàn bộ nội dung**. Trong khi đó `robots.txt` lại ghi `Allow: /` cho Googlebot/Bingbot và `Disallow: /` cho `User-agent: *` — tức là hai bot site *muốn* mời thì bị tường lửa chặn, hai bot site *cấm* thì tường lửa mở cửa. Nhờ đường này mới lần đầu đọc được nội dung thật của site.
  - **8 lỗi cấu trúc lần đầu đánh giá được** (hai audit trước bị chặn hoàn toàn nên không thấy): (1) không có `JobPosting` schema nào → không đủ điều kiện vào Google Jobs; (2) không có URL riêng cho từng tin tuyển dụng; (3) mọi trang phân trang canonical về `/jobs` → 42/52 tin vô hình với công cụ tìm kiếm; (4) **4/9 URL trong sitemap trả về vỏ Admin Portal rỗng** (gồm `/pages/info-for-employers` và `/pages/info-for-job-seekers` — hai trang thương mại quan trọng nhất), `/llms.txt` và `/job/list` cũng vậy; (5) `BreadcrumbList` trỏ crawler vào chính `/job/list` rỗng đó; (6) `index-sitemap.xml` sai cú pháp (phần tử `<sitemap>` trỏ tới trang, không phải tệp sitemap); (7) hreflang không đối xứng — trang EN khai `en` hai lần và thiếu hoàn toàn `nl` nên Google sẽ bỏ qua cả cụm, dù site có bản NL thật tại `/nl`; (8) blog rỗng 0 bài, 5/11 danh mục không có tin nào.
  - **Bức tranh nguồn cung**: 52 tin, ~40 nhà tuyển dụng (Accenture, Cegeka, Sendcloud, Mollie, Heijmans, Rexel, VINCI Energies, Boltrics, Winparts…), **100% tin đều hiển thị "Posted 1 month ago"**, 49/52 ở Hà Lan, 3 tin ở Mỹ qua aggregator Lensa, 100% full-time.
  - **Mâu thuẫn định vị phát hiện được**: meta và schema nói *"European job board"* / *"top European companies"*, tên miền `.eu`; nhưng nội dung trang chủ nói về sinh viên **Noord-Brabant** rời quê ra **Randstad** và hiển thị việc làm ở **cấp độ địa chỉ chính xác** kèm khoảng cách từ nhà. Hai câu chuyện nhắm hai tập từ khóa và hai tập đối thủ khác nhau — đã đưa thành quyết định số 2 phải chốt, kèm khuyến nghị rõ chọn phương án vùng Hà Lan (mọi bằng chứng đều chỉ về hướng đó).
  - **8 tài liệu đã tạo** (2.071 dòng):
    - [`onlyaijobs/seo-geo-audit-onlyaijobs-eu-2026-09-08.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/onlyaijobs/seo-geo-audit-onlyaijobs-eu-2026-09-08.md) (246 dòng) — audit lần 3 với toàn bộ bằng chứng thô thu hôm nay
    - [`onlyaijobs/onlyaijobs_info.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/onlyaijobs/onlyaijobs_info.md) (218 dòng) — master brief tương đương `manifera_info.md`, mọi trường chưa xác minh được đánh dấu 🟥 **CẦN BỔ SUNG** thay vì bịa
    - [`onlyaijobs/seo_geo_plan_onlyaijobs.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/onlyaijobs/seo_geo_plan_onlyaijobs.md) (446 dòng) — kế hoạch theo **4 cổng chặn** nối tiếp nhau, yêu cầu đầy đủ của `JobPosting` schema, kiến trúc programmatic SEO kèm **ngưỡng tối thiểu số tin** để không sinh trang rỗng, kế hoạch blog từ 0 bài
    - [`onlyaijobs/google_ads_keywords_onlyaijobs.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/onlyaijobs/google_ads_keywords_onlyaijobs.md) (262 dòng) — 7 chiến dịch, 9 ad group song ngữ EN/NL, 5 danh sách negative
    - [`onlyaijobs/google_ads_rsa_copy_onlyaijobs.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/onlyaijobs/google_ads_rsa_copy_onlyaijobs.md) (238 dòng) — 79 headline + 24 description EN/NL, đã đếm ký tự bằng script, 0 dòng vượt giới hạn 30/90
    - [`onlyaijobs/paid_ads_plan.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/onlyaijobs/paid_ads_plan.md) (232 dòng) — đa kênh, 3 tier €1.140/€2.600/€5.000, UTM có trường `<side>` bắt buộc để tách hai phía marketplace
    - [`onlyaijobs/implementation_plan.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/onlyaijobs/implementation_plan.md) (284 dòng) — kế hoạch 12 tháng, phân tích đối thủ, 5 kênh lấy nguồn tin xếp theo chi phí, 8 câu hỏi cần chốt
    - [`onlyaijobs/extra-keywords.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/onlyaijobs/extra-keywords.md) (145 dòng) — 9 nhóm seed keyword EN/NL
  - **Khác biệt căn bản so với bộ tài liệu Manifera**: Manifera có CSV 1.595 từ khóa nên mọi con số đều là dữ liệu thật; OnlyAIJobs **chưa từng chạy nghiên cứu từ khóa nào**, nên toàn bộ ô Volume/Bid ghi `TBD` kèm hướng dẫn cách lấy dữ liệu — không điền số ước đoán vào bất kỳ bảng nào.
  - **Luận điểm chiến lược xuyên suốt**: đây là marketplace hai chiều đang thiếu hàng (52 tin cũ 1 tháng). Nguyên tắc **"mua nguồn cung, đừng mua nhu cầu"** — mọi nhóm quảng cáo nhắm người tìm việc bị khóa sau cột mốc 120 tin đang hiệu lực; ngân sách giai đoạn đầu dồn hết vào việc lấy thêm tin tuyển dụng, và kênh rẻ nhất không phải quảng cáo mà là quay lại 40 nhà tuyển dụng đã đăng + đối tác vùng (Brainport Eindhoven, Midpoint Brabant, gemeente, TU/e, Fontys) — vì câu chuyện chống chảy máu nhân tài vùng chính là mục tiêu chính sách của họ.
  - **Kiểm định**: 0 link nội bộ gãy giữa 8 tài liệu; toàn bộ bằng chứng kỹ thuật đều kèm lệnh curl tái lập được; chứng chỉ TLS xác minh lại hôm nay (cấp 9/8/2026, hết hạn 7/11/2026 — bình thường).
- **17:40**: Bổ sung **bộ 6 tài liệu marketing cho Manifera** — trước đây LaunchStudio có đủ kế hoạch SEO/Ads/triển khai còn Manifera thì không có tài liệu nào, dù kho nội dung Manifera lớn hơn (1.460 bài EN so với 1.330 bài của LaunchStudio):
  - [`manifera/google_ads_keywords_manifera.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/manifera/google_ads_keywords_manifera.md) (347 dòng): 9 chiến dịch, 8 ad group, ~90 từ khóa **kèm volume/competition/bid thật** trích từ `keyword-planner-manifera.com-2026-06-12 (1).csv`, 6 danh sách negative dùng chung, ad extensions, lộ trình 30 ngày. Khác với bản LaunchStudio (các ô từ khóa để trống), bản này điền đầy đủ dữ liệu.
  - [`manifera/google_ads_rsa_copy_manifera.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/manifera/google_ads_rsa_copy_manifera.md) (286 dòng): 105 headline + 28 description cho 7 nhóm quảng cáo, **đã đếm ký tự bằng script** — 100% nằm trong giới hạn 30/90 của Google, kèm chiến lược ghim vị trí và lịch xoay copy.
  - [`manifera/paid_ads_plan.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/manifera/paid_ads_plan.md) (322 dòng): kế hoạch đa kênh (Google, LinkedIn ABM, thư mục agency Clutch/Sortlist, Bing, Meta, Reddit), 3 mức ngân sách €3.000/€6.000/€12.000, quy ước UTM, 3 landing page bắt buộc, KPI và checklist 90 ngày.
  - [`manifera/seo_geo_plan_vendor_keywords.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/manifera/seo_geo_plan_vendor_keywords.md) (543 dòng): kiến trúc pillar/cluster ánh xạ **đúng 17 thư mục nội dung thật**, 5 brief money page, kế hoạch xuất bản 1.382 bài theo 5 pha, kế hoạch thực thể/schema ở tầng Yoast, bản viết lại `llms.txt`, lịch 90 ngày.
  - [`manifera/implementation_plan.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/manifera/implementation_plan.md) (278 dòng): kế hoạch marketing tổng thể 12 tháng — hiện trạng, đối thủ, định vị, kênh, referral, CRO, KPI theo quý, ngân sách, 4 phase, 7 câu hỏi cần ban lãnh đạo quyết.
  - [`manifera/extra-keywords.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/manifera/extra-keywords.md) (95 dòng): seed keyword cho 7 mảng CSV không phủ (Magento/webshop, staff augmentation, legacy modernization, EU cloud/GDPR, ngành dọc, AI, so sánh thương hiệu).
  - **Ba phát hiện định hình toàn bộ bộ tài liệu**:
    1. **CSV từ khóa gây hiểu lầm nặng**: tổng 137.460 volume/tháng nhưng riêng `software in software` (49.500 — rác cú pháp) và `dev ops` (5.400 — intent nghề nghiệp) đã chiếm 40%. Nhu cầu tìm kiếm thương mại thật chỉ ~900–1.200 lượt/tháng toàn cầu. Tiền nằm ở từ khóa volume thấp nhưng bid cao: `custom software development companies` chỉ 70 volume nhưng bid $14,33–$34,36.
    2. **1.460 bài đã viết nhưng theo kiểm kê chỉ ~78 mục được đánh dấu đã đăng** — Manifera không thiếu nội dung, thiếu kênh phân phối và kiến trúc. Nút thắt thực tế là cơ chế publish hàng loạt (đăng tay 25 bài/tuần mất 55 tuần).
    3. **200 bài local đã kiểm tra: không có rủi ro doorway page** — mẫu Amsterdam (persona CTO, góc Zuidas) và Heemskerk (persona CFO, góc chi phí IJmond) khác biệt thật sự, 1.800–2.200 từ mỗi bài, không phải bản thay tên thành phố.
  - **Quyết định nhất quán xuyên suốt**: toàn bộ tài liệu thuần tiếng Anh cho manifera.com (phần `/nl/` cũ đã ngừng theo Finding #6 của audit) — không có ad group hay landing page tiếng Hà Lan vì không có trang tiếng Hà Lan để đổ traffic vào.
  - **Kiểm định**: 0 link nội bộ gãy giữa 6 tài liệu; mọi số volume/bid đối chiếu lại trực tiếp với CSV gốc; số bài viết đếm lại từ hệ thống tệp là **1.460** (nhật ký ngày 08/09 ghi 1.459 do một bài có chữ "social" trong slug bị lọc nhầm khi đếm).
- **17:25**: Xử lý dứt điểm lỗi **trùng slug/URL giữa các bài viết khác nhau** trên cả hai site, đồng thời vá nốt một biến thể placeholder bị bỏ sót ở bước thay link ban đầu:
  - **Bản chất lỗi**: nhiều bài viết hoàn toàn khác nhau (độ tương đồng nội dung chỉ 5–18%) lại dùng chung một slug, tức khi đăng lên web chúng sẽ đè lên cùng một URL — bài đăng sau ghi đè bài đăng trước. Đây là lỗi cấu trúc, không phải trùng lặp nội dung.
  - **Quy mô thực tế lớn hơn ước tính ban đầu**: rà lại toàn bộ theo slug tệp (thay vì chỉ theo canonical) cho thấy **71 nhóm trùng / 162 bài** — LaunchStudio 12 nhóm (`2026/november-2026` 11 nhóm + 1 cặp `role-of-ai-product-manager` giữa `july-2026` và `august-2026`), Manifera 59 nhóm trải khắp `2026/` và `extra-7-random`.
  - **Cách xử lý**: mỗi nhóm giữ nguyên bài sớm nhất theo thứ tự tháng xuất bản (`july` -> `december`, cụm `2026-extra` xếp sau); **91 bài còn lại (11 + 80, chạy làm hai đợt) được đặt slug mới** sinh từ tiêu đề H1 theo công thức `<từ-khóa-chính>-<3 từ đặc trưng>`, giữ nguyên từ khóa SEO ở đầu slug để không mất tín hiệu tìm kiếm. 62/91 slug tự sinh được rà và chỉnh tay lại cho gọn nghĩa (ví dụ `devops-software-tools-fix-broken` -> `devops-software-tools-cant-fix-processes`).
  - **Đổi tên đồng bộ 207 tệp**: mỗi bài kéo theo toàn bộ biến thể (`.md`, `_dutch.md`, `-social.md`, `-social_dutch.md`, ảnh `_pic`), thực hiện bằng `git mv` để giữ lịch sử; đồng thời cập nhật URL `/blog/<slug>` bên trong chính các tệp đó.
  - **Cập nhật 4 bảng kiểm kê**: sửa đúng dòng chứa đường dẫn tệp được đổi tên (không thay thế mù toàn cục, tránh đụng nhầm các bài trùng số thứ tự ở thư mục khác).
  - **Vá placeholder bị bỏ sót**: phát hiện thêm biến thể `[Link]` (khác với `[Link to article]` / `[Link naar artikel]` đã xử lý) trong **147 bài social** — 126 của LaunchStudio, 30 của Manifera. Đã thay bằng URL thật theo đúng thứ tự ưu tiên như trước (120 lấy từ schema bài gốc, 27 theo quy tắc slug).
...
- **16:41**: Sửa lỗi **nhầm lẫn ngôn ngữ EN/NL** trong 960 bài viết tiếng Hà Lan của LaunchStudio (`2026/` và `2026-extra/`) — lỗi phát hiện được trong lúc thay link social ở bước trước:
  - **Lỗi 1 — canonical sai ngôn ngữ (500 bài)**: `mainEntityOfPage.@id` của bài NL trỏ về `https://launchstudio.eu/en/blog/<slug>` thay vì `/nl/blog/<slug>`. Hệ quả SEO: bài Hà Lan tự khai canonical là bản tiếng Anh, khiến Google gộp hai phiên bản làm nội dung trùng lặp và loại bản NL khỏi kết quả tìm kiếm tiếng Hà Lan.
  - **Lỗi 2 — author.url sai ngôn ngữ (490 bài)**: trường `author.url` trong JSON-LD trỏ `https://launchstudio.eu/en/` thay vì `/nl/`.
  - **Lỗi 3 — link CTA trong thân bài trỏ sang site tiếng Anh (926 bài, 1.436 lượt)**: các nút kêu gọi hành động trong bài Hà Lan dẫn người đọc sang trang tiếng Anh — `/en/#contact` (608), `/en/` (403), `/en/#calculator` (222), `/en/#packages` (112), `/en/#process` (87), `/en/#proof` (4).
  - **Lỗi 4 — nhãn link lệch href (4 bài)**: sau khi sửa href, phần chữ hiển thị của link vẫn ghi `launchstudio.eu/en/#...` trong khi href đã là `/nl/`; đã đồng bộ lại nhãn.
  - **Cố ý giữ nguyên 3 liên kết**: 2 link tới `/en/insights/...` (chưa có bản `/nl/` tương ứng trong repo) và 1 URL chiến dịch quảng cáo tiếng Anh trong [`launchstudio/paid_ads_plan_dutch.md`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/launchstudio/paid_ads_plan_dutch.md) (đúng chủ đích, không phải lỗi).
  - **Kiểm định**: 0 bài NL còn canonical/author/link trỏ nhầm `/en/`; 0 bài EN trỏ nhầm `/nl/`; **1.495 khối JSON-LD parse thành công 100%**, không khối nào hỏng cú pháp sau khi sửa.
  - **Tồn đọng đã ghi nhận, chưa xử lý**: 206 bài LaunchStudio trong `2026/` **hoàn toàn không có khối JSON-LD**; 862 bài LaunchStudio + 406 bài Manifera thiếu `mainEntityOfPage`; 862 bài LaunchStudio + 46 bài Manifera thiếu `datePublished`; gần như toàn bộ bài của cả hai site thiếu `inLanguage` và chưa có khai báo `hreflang` cho cặp EN/NL.
- **16:16**: Thay thế toàn bộ placeholder link trong **3.785 bài đăng Social Media** của cả LaunchStudio và Manifera bằng URL bài viết thật, xử lý tự động bằng script Python có kiểm định nhiều lớp:
  - **Phạm vi**: 2.540 tệp `launchstudio/` + 1.245 tệp `manifera/`, trải khắp `2026-extra/` (21 cụm) và `2026/` (6 thư mục theo tháng của mỗi site). Hai dạng placeholder được xử lý: `[Link to article]` (2.525 tệp) và `[Link naar artikel]` (1.260 tệp).
  - **Nguồn URL theo thứ tự ưu tiên** (không suy đoán khi đã có dữ liệu chuẩn):
    1. **Schema (2.697 tệp)**: đọc trực tiếp `mainEntityOfPage.@id` trong JSON-LD của chính bài viết gốc tương ứng — nguồn chuẩn xác tuyệt đối, giữ nguyên cả các slug đã rút gọn khác tên tệp (105 trường hợp, ví dụ `44-what-does-production-ready-actually-mean-ai-application.md` -> `/blog/what-does-production-ready-mean-ai-application`).
    2. **Bài song ngữ (162 tệp)**: bài cùng ngôn ngữ thiếu schema thì mượn slug từ bài ngôn ngữ còn lại rồi hoán đổi tiền tố `/en/` <-> `/nl/`.
    3. **Quy tắc slug (926 tệp)**: bỏ tiền tố số thứ tự và hậu tố ngôn ngữ, ghép theo cấu trúc site. Đã đối chiếu quy tắc này với 3.680/3.785 URL lấy từ schema để xác nhận độ khớp trước khi áp dụng.
  - **Cấu trúc URL**: `https://launchstudio.eu/en/blog/<slug>` (1.270), `https://launchstudio.eu/nl/blog/<slug>` (1.270), `https://www.manifera.com/blog/<slug>` (1.245).
  - **Phát hiện & xử lý lỗi dữ liệu tồn đọng**: **443 bài viết tiếng Hà Lan** khai báo `mainEntityOfPage` trỏ nhầm sang URL `/en/` thay vì `/nl/` (tập trung ở `extra-2`, `extra-3`, `extra-4`, `extra-5-local`, `extra-6-random`, `extra-7-longtail` và `2026/december-2026`). Script đã sao chép trung thực URL sai này nên đã chạy bước hiệu chỉnh riêng, đưa 443 bài social NL về đúng `/nl/blog/`. **Lưu ý: bản thân 443 tệp bài viết NL vẫn còn canonical sai — cần sửa ở bước riêng.**
  - **Kiểm định sau khi chạy**: 0 placeholder còn sót trong toàn bộ tệp social; 0 bài social NL trỏ nhầm `/en/`; 0 bài social EN trỏ nhầm `/nl/`; 3.749 URL duy nhất trên 3.785 tệp (36 tệp trùng URL là do 11 cặp bài trùng slug có sẵn ở `2026/november-2026` và 4 nhóm bài trùng tiêu đề của Manifera giữa các tháng — vấn đề nội dung trùng lặp có từ trước, không phải lỗi thay link).
  - **Sản phẩm phụ**: bảng ánh xạ đầy đủ `tệp -> URL -> nguồn` được lưu lại phục vụ đối soát khi đăng bài.
- **13:52**: Tiếp tục tạo ảnh minh họa cho **Bài 77** thuộc [`launchstudio/2026-extra/extra-8-decision/`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/launchstudio/2026-extra/extra-8-decision/) chuẩn **Phong cách & Thị giác Hình 47** (Modern flat-ish vector illustration / Dribbble corporate tech style, 100% Zero text/numbers, tỷ lệ 16:9 `1024x576` PNG):
  - **Bài 77**: `77-launchstudio-vs-ai-coding-agent-autonomous.md` -> [`77-launchstudio-vs-ai-coding-agent-autonomous_pic.png`](file:///Users/mac/Library/Mobile%20Documents/com~apple~CloudDocs/sickn33/launchstudio/2026-extra/extra-8-decision/77-launchstudio-vs-ai-coding-agent-autonomous_pic.png)
    - *Layout*: Bố cục đối chiếu năng lực kiểm định kiến trúc (Autonomous Sandbox Loop vs Senior Human-AI Engineering Judgment Crucible). Bên trái là khoang kính hình trụ chứa robot tự hành quay vòng lặp code và thẻ xanh tự phê duyệt khép kín; ở trung tâm và bên phải, kỹ sư cao cấp và robot AI trợ thủ (visor cyan) phối hợp phân tích mô hình kiến trúc hologram đa tầng, lắp đặt tấm khiên bảo vệ Row-Level Security ngọc lục bảo dày dặn và két webhook bọc ổ khóa vàng kết nối đường ống dữ liệu cyan mượt mà. 100% không chữ/số.
  - **Xử lý tỷ lệ & Lưu tệp**: Cắt crop chuẩn tỷ lệ 16:9 (`1024x576`), tối ưu hóa nén PNG và lưu đồng thời vào thư mục bài viết và artifacts.
  - **Ghi chú hạn ngạch tạo ảnh**: Công cụ tạo ảnh bản quyền hệ thống đạt ngưỡng giới hạn hạn ngạch tạm thời (Gemini 3.1 Flash Image Quota 429) khi khởi tạo Bài 78 (thông báo reset sau khoảng 8 phút, dự kiến lúc 14:01). Tuân thủ nghiêm ngặt quy tắc Workspace (không sử dụng pollinations.ai), tạm dừng tại Bài 77 và báo cáo người dùng.
