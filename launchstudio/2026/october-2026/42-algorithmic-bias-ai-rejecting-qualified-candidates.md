...
### An AI-Native Founder in Action: Candidate Anonymization & Bias-Scan Pipelines

Nora, a recruiter, used **Cursor** to build a resume screening portal. The model biased against candidates with non-traditional career paths, rejecting qualified profiles.

She partnered with **LaunchStudio (by Manifera)** to build candidate data anonymizers and bias-filtering guardrails.

**Result:** Selection diversity rose by 40% while preserving matching quality.

**Cost & Timeline:** €2,300 (Bias Prevention Package) — production-ready and deployed in 5 business days.
