🔥 David built a prototype using **Cursor** — david, a technical founder in london, used **cursor** to rapidly build a frontend prototype for a micro-investing platform, but discovered critical architectural and security bottlenecks before going live. 🧠
