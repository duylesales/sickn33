🔥 Noah built a prototype using **Lovable** — noah, a retail operations lead, used **lovable** to build a customer bot, but discovered critical performance and architecture bottlenecks before scaling to production. 🧠
