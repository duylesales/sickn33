🔥 Stella built a prototype using **Cursor** — stella, a writer, used **cursor** to build a copy generator, but discovered critical performance and architecture bottlenecks before scaling to production. 🧠
