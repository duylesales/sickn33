  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Generieke 'spray and bid'-e-mail is dood. Hyper-gepersonaliseerde, zeer relevante koude e-mail is echter effectiever dan ooit, omdat deze zich duidelijk onderscheidt van de door AI gegenereerde spam."
      }
    },
    {
      "@type": "Question",
      "name": "Hoe kan ik een e-mail op grote schaal hyperpersonaliseren?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Gebruik een AI-verrijkingspijplijn. Schraap de recente LinkedIn-posts en bedrijfsnieuws van de prospect, geef deze door aan een LLM en laat de LLM een aangepaste openingszin schrijven waarin wordt verwezen naar hun specifieke situatie."
      }
    },
    {
      "@type": "Question",
      "name": "Hoe lang moet een koude B2B-e-mail zijn?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Minder dan 100 woorden. Zakelijke kopers lezen e-mails op hun telefoon tussen vergaderingen door. Houd het bij drie zinnen: context, waardepropositie en een oproep tot actie."
      }
    },
    {
      "@type": "Question",
      "name": "Wat is 'domeinopwarming'?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Het proces waarbij gedurende enkele weken langzaam een ​​klein, toenemend aantal e-mails wordt verzonden vanaf een nieuw domein om een ​​positieve afzenderreputatie bij Google en Microsoft op te bouwen, voordat een volledige campagne wordt gelanceerd."
      }
    },
    {
      "@type": "Question",
