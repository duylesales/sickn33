🔥 Alexander built a prototype using **Bolt** — alexander, a founder, used **bolt** to build a pitch deck builder, but discovered critical performance and architecture bottlenecks before scaling to production. 🧠
