...
### An AI-Native Founder in Action: Anonymizing Profiles and Setting Bias Filters for HR Screening

Audrey, an HR manager, used **Bolt** to build a job matcher. The model biased against candidates with non-traditional career paths, rejecting qualified profiles.

She worked with **LaunchStudio (by Manifera)** to implement candidate data anonymizers and bias-filtering guardrails.

**Result:** Selection diversity rose by 45% while preserving matching quality.

**Cost & Timeline:** €2,600 (Recruitment Compliance Package) — production-ready and deployed in 5 business days.
