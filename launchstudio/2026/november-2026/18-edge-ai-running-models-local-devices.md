...
### An AI-Native Founder in Action: Compiling an ONNX Model for Offline Mobile App Execution

Harper, a field researcher, used **Cursor** to build an offgrid catalog. The app regularly crashed in mountain areas due to lack of network connections.

She worked with **LaunchStudio (by Manifera)** to compile a lightweight ONNX model executing directly on mobile devices.

**Result:** The app operates offline, protecting battery life and saving data fees.

**Cost & Timeline:** €2,800 (Edge AI Compilation) — production-ready and deployed in 6 business days.
