...
rows_nov, next_stt = process_month('november-2026', 'November', 61)
rows_dec, _ = process_month('december-2026', 'December', next_stt)
...
print("Added November and December to content_inventory.md")
