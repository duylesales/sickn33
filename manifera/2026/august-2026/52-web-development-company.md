...
PMI's own research explains the mechanism. The **2018 Pulse of the Profession** report found that **52% of projects experienced scope creep** — uncontrolled changes to what was originally agreed — up from 43% five years earlier. A 150-feature RFP is, by definition, a single upfront specification frozen before any real user has touched the product. PMI's data says this specification will be wrong for roughly half of all projects, and when it is wrong, the cost consequence is not marginal.

Separate research on IT project cost performance puts a number on that consequence. Bent Flyvbjerg and Alexander Budzier's Harvard Business Review study (*"Why Your IT Project May Be Riskier Than You Think,"* September 2011), analyzing 1,471 IT projects, found an **average cost overrun of 27%** — and that roughly one in six projects was a "Black Swan," overrunning by an average of 200% in cost and nearly 70% in schedule. Apply that 27% average to the earlier example: an €80,000 low bid is not really an €80,000 commitment. At the *average* documented IT project overrun rate, the realistic expected cost is closer to **€101,600** before a single adversarial "Change Request" markup is applied on top — and that figure ignores the one-in-six chance of a Black Swan outcome entirely. Fixed-price vendors, as described above, use exactly the moment scope creep surfaces to charge premium rates rather than absorb it as normal project evolution.
...
Yes. The Standish Group's CHAOS Report, the longest-running study of software project outcomes, has consistently found that only around 31% of software projects fully succeed on time, on budget, and with the required features, while roughly half are "challenged" and the rest are cancelled. Separately, PMI's 2018 Pulse of the Profession found that 52% of projects experience scope creep. And Flyvbjerg and Budzier's Harvard Business Review study of 1,471 IT projects found an average cost overrun of 27%, with one in six projects becoming a "Black Swan" that overran by 200% on average. A fixed-price RFP freezes 150 features before real usage data exists, which is precisely the condition all three studies identify as the leading predictor of budget overrun.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. The Standish Group's CHAOS Report has consistently found that only around 31% of software projects fully succeed on time, on budget, and with required features, while roughly half are challenged and the rest cancelled. PMI's 2018 Pulse of the Profession found 52% of projects experience scope creep. Flyvbjerg and Budzier's Harvard Business Review study of 1,471 IT projects found an average cost overrun of 27%, with one in six projects becoming a 'Black Swan' overrunning by 200% on average. A fixed-price RFP freezes features before real usage data exists, the leading predictor of overrun identified across all three studies."
      }
    }
  ]
}
